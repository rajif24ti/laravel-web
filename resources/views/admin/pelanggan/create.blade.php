...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            ...
            <p class="mb-0">Isi form berikut untuk menambahkan data pelanggan baru.</p>
        </div>
        <div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="last_name" name="last_name"
                                    class="form-control" placeholder="Masukkan nama belakang" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="gender" name="gender" class="form-select mb-0" aria-label="Gender select example">
